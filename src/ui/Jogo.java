...
public class Jogo {
	...
	private void initialize() {
		...
		tabbedPane.addTab("Histórico", null, painel_historico, null);
		...
		// Inicialização Botões Menu principal //
		...
		// Inicialização Botões Carregar Jogo //
		...
		// Inicialização Botões Histórico //
		...
		// Botão de Novo jogo (Iniciador da partida)
		...
		// Botão para passar para o próximo jogador
		...
		// Lida com o botão de resolver o puzzle automaticamente
		btAutoResolve.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				btNextPlayer.setVisible(true); // Deixa possível passar para o próximo jogador
			}
		});
	}
}
